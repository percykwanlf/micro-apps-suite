...
export default function ShiftNomad({ onBackToSuite }) {
        ...
        {typeof onBackToSuite === 'function' ? (
          <nav className="mb-6" aria-label="Suite navigation">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white/90 px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-600 shadow-sm transition hover:border-sky-300 hover:text-sky-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500"
            >
